...
const I18N_ZH = {
  ...
  'The streets glow again and a corner of the world map lights up. The grey trail leads into the pines…': '街道重新亮起，世界地图的一角被点亮。灰色的踪迹延伸进了松林……',
  'The woods crawl with grey. The minions here shoot straighter — keep moving, weave between the pines, and clear every camp on the trail.': '林子里爬满了灰色。这里的爪牙打得更准——保持移动，在松树间穿梭，清空路线上的每一处营地。',
  'The forest breathes colour again. One trail left on the map — it ends at the midnight fair. Something big is waiting.': '森林重新有了颜色。地图上只剩最后一条路——终点是午夜游乐园。有个大家伙在等着。',
  'The fair at the end of the world map — and THERE it is. Fight through its guard, then face the ERASER. Watch its volleys and the charge: keep moving and it cannot touch you.': '世界地图尽头的游乐园——它就在那里。先打穿它的守卫，然后直面橡皮擦。留意它的扇形弹幕和冲撞前的预警：只要一直移动，它就碰不到你。',
  'SPLAT! The Eraser crumbles into shavings, the fair lights up, and the whole world map shines again. The town is saved… until chapter two. THE END.': '啪叽！橡皮擦碎成一地橡皮屑，游乐园亮起，整张世界地图重新闪耀。世界得救了……直到第二章。第一章 · 完。',
