...
const I18N_ZH = {
  ...
  /* ---- home & adventure ---- */
  'CAREER': '生涯模式',
  'Stages, stars and unlocks': '阶段星章 · 解锁地图',
  'ADVENTURE': '闯关模式',
  'The story of the Eraser': '橡皮擦的故事线',
  advBlurb: '第一章 · 灰色来袭 —— 小镇的颜色正在被擦掉。',
  'RESTART STORY': '重新开始故事',
  'CO-OP — COMING SOON': '双人协作 · 敬请期待',
  'CONTINUE': '继续闯关',
  'LEVEL': '关卡',
  'TAP TO PLAY': '点击进入',
  'HERO': '主角',
  ...
  'LEVEL CLEAR!': '通关！',
  'LEVEL FAILED': '挑战失败',
  'The grey wins this round… try again!': '这一回合灰色赢了……再试一次！',
  'GOAL': '目标',
  'BOSS': 'BOSS',
  'splats': '击倒',
  'You found the {w}!': '你找到了传说武器 {w}！',
  'the legendary sprayer': '传说中的喷枪——全面强于任何初始武器',
  'three streams, one trigger': '一次三道漆流的传说散射',
  'slow strokes that explode': '每一笔都会爆炸的传说重刷',
  'THE ERASER is furious!': '橡皮擦狂暴了！！',
  'The Smudge smears off fresh minions!': '污渍抹出了新的爪牙！',
  '{n} was erased!': '{n} 被擦掉了！',
  'CHAPTER ONE · THE GREY': '第一章 · 灰色来袭',
  'THE ERASER wakes up!': '橡皮擦醒了！！',
  'Ambush! Splat them all!': '遭遇战！把它们全泼倒！',
  'Area clear! Follow the arrow.': '区域点亮！跟着箭头走。',
  'AREA': '区域',
  'foes left': '个敌人',
  'Back to the last cleared area…': '回到上一个点亮的区域……',
  'The Eraser has drained the world grey, block by block. Its minions patrol the old streets — follow the route, wake them, splat every last one!': '橡皮擦把世界一块一块吸成了灰色。它的爪牙在旧街区巡逻——沿着路线前进，惊醒它们，然后一个不剩地泼倒！',
  'The streets glow again and a corner of the world map lights up. The grey trail crosses the river…': '街道重新亮起，世界地图的一角被点亮。灰色的踪迹越过了河……',
  'Grey patrols hold both banks and the bridges between them. Sweep the riverside clean — mind the crossings, they love an ambush.': '灰色巡逻队占着两岸和桥梁。把河畔清扫干净——小心桥头，它们最爱在那里设伏。',
  'Both banks shine again. The trail slips away toward the midnight fair — something is performing there.': '两岸重新亮了起来。踪迹溜向午夜游乐园——那里有什么东西正在"演出"。',
  'The chalk fair has a new act: a SHADOW of the Eraser. Clear its guard, then pop the copy — watch the volleys, keep your feet moving.': '粉笔游乐园上了新节目：一个橡皮擦的影子分身。先清掉它的守卫，再戳破这个复制品——留意弹幕，脚别停。',
  'The shadow bursts like a soap bubble… a decoy! The real trail runs into the pines. The map lights up anyway — take the win.': '影子像肥皂泡一样炸开……是诱饵！真正的踪迹通向松林。不过地图照样点亮——这一局照收。',
  'The woods crawl with grey. The minions here shoot straighter — weave between the pines and clear every camp on the trail.': '林子里爬满了灰色。这里的爪牙打得更准——在松树间穿梭，清空路线上的每一处营地。',
  'The forest breathes colour again. Deeper in, the ferns are still grey…': '森林重新有了颜色。更深处，蕨谷还是灰的……',
  'Down in the hollow the grey hides behind giant mushrooms. Flush every patrol out of the ferns — the creek crossings are choke points.': '谷底的灰色躲在巨型蘑菇后面。把每支巡逻队都从蕨丛里赶出来——小溪渡口是咽喉要道。',
  'The hollow hums with colour. The trail climbs — up into the frozen pass.': '蕨谷重新哼起了彩色的调子。踪迹向上爬——通往冰封的山口。',
  'Grey squads camp across the snowfields — and the ice lakes will carry you straight through their fire lanes if you are not careful. Skate smart.': '灰色小队在雪原上扎营——一不小心，冰湖会带着你直接滑进它们的火力路线。滑得聪明点。',
  'The pass is painted. Far below, the shore is under siege…': '山口被涂满了。而在山脚远处，海岸正被围攻……',
  'A SMUDGE — a bigger, meaner copy — leads the siege on the shore. Break its beach patrols first, then knock it into the tide. Its fan is wider: dodge sideways, not backwards.': '一个"污渍"——更大更凶的复制品——正指挥围攻海岸。先打散沙滩巡逻队，再把它揍进潮水里。它的扇形弹幕更宽：往侧面躲，别往后退。',
  'The smudge dissolves into the surf. Two trails left on the map — and they both point at the volcano rim. Almost there.': '污渍溶进了浪花。地图上只剩两条踪迹——都指向火山口。快到了。',
  'The grey has reached the desk itself — the paper the whole world is drawn on. Clear the stationery line by line before it erases the source.': '灰色已经蔓延到书桌本身——整个世界就画在这张纸上。趁它抹掉源头之前，把文具间一格一格清干净。',
  'The desk is safe, the doodles keep breathing. Next stop: the crater fields.': '书桌安全了，涂鸦们还在呼吸。下一站：环形山。',
  'Even the moon is turning grey. March crater to crater and wipe out the lunar patrols — the final trail starts here.': '连月亮都在变灰。从一个环形山推进到下一个，歼灭月面巡逻队——最终的踪迹从这里开始。',
  'The moon glows in four colours. One region left on the map, and it is glowing red: the volcano. The REAL Eraser is waiting.': '月亮亮起了四种颜色。地图上只剩一块区域，泛着红光：火山。真正的橡皮擦在等你。',
  'The volcano rim — and the REAL Eraser, huge and furious. Five-shot fans, quicker charges, and lava underfoot. Keep moving, keep painting, and end the grey for good.': '火山口——真正的橡皮擦，庞大而暴怒。五连扇形弹幕、更快的冲撞、脚下还有岩浆。保持移动，保持涂色，彻底终结灰色。',
  'SPLAT! The Eraser crumbles into a mountain of shavings and every region on the map blazes with colour. The world is saved… until chapter two. THE END.': '啪叽！橡皮擦碎成一座橡皮屑山，地图上每一块区域都燃起色彩。世界得救了……直到第二章。第一章 · 完。',
  ...
  'Double Threat': '双管齐下',
  'Win with 30% coverage and 5 splats in one match.': '单场 30% 覆盖 + 5 次击倒并获胜。',
  'Rising Star': '冉冉新星',
  ...
  'Find the door to another town.': '找到通往另一座城的那扇门。',
  'King of the Other Side': '彼界之王',
  'Win a match that ends in the other town.': '在异界小镇结束的对局中获胜。',
  'Pencil Case Stowaway': '铅笔盒偷渡客',
  'Squeeze in through the zipper.': '从拉链缝里钻进去。',
  'Keeper of the Case': '铅笔盒之主',
  'Win a match that ends inside the pencil case.': '在铅笔盒内部结束的对局中获胜。',
  'You squeeze in through the zipper…': '你从拉链缝里挤了进去……',
  'WELCOME TO THE INSIDE.': '欢迎来到盒中世界。',
  ...
  /* ---- mode ---- */
  'paint the town, splat the rest': '涂色抢地盘，击倒也算分',
  'SCORE': '得分',
  'takes the town!': '拿下全城！',
