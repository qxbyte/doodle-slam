...
const I18N_ZH = {
  ...
  '{n} was erased!': '{n} 被擦掉了！',
  'The Eraser has drained the town grey. Two of its minions are on patrol — splash 30% of the streets back to colour before time runs out!': '橡皮擦把小镇吸成了灰色。它的两个爪牙正在巡逻——在时间耗尽前，把 30% 的街道泼回彩色！',
  'The streets glow again. But the trail of grey dust leads into the pines…': '街道重新亮了起来。但灰色粉末的踪迹一路延伸进了松林……',
  'The woods are crawling with minions. Paint 25% of the camp AND splat 4 of them to clear the way.': '林子里到处是爪牙。涂满营地 25% 的地面，并击倒 4 个爪牙，杀出一条路。',
  'The pines breathe colour again. One trail left — it leads to the midnight fair. It is THERE.': '松林重新有了颜色。只剩最后一条踪迹——通向午夜游乐园。它就在那里。',
  'There it is. The ERASER itself, wiping the fair off the board. It erases every inch it crosses — splat it with everything you have!': '就是它。橡皮擦本尊，正把游乐园从黑板上抹掉。它经过的每一寸地面都会被擦除——用你的一切泼倒它！',
  'SPLAT! The Eraser crumbles into shavings and the fair lights up. The town is safe… for now. THE END — of chapter one.': '啪叽！橡皮擦碎成了一地橡皮屑，游乐园重新亮起。小镇安全了……暂时。第一章 · 完。',
