...
const TEAMS = [
  { id: 0, name: 'SPLASH', color: '#2f66e0', dark: '#1d47a8', desc: 'Cool-headed turf tactician. Team Blue.' },
  { id: 1, name: 'BAM',    color: '#e6392a', dark: '#a8231a', desc: 'Hot-blooded rusher. Team Red.' },
  { id: 2, name: 'ZIP',    color: '#f0b41c', dark: '#b5830f', desc: 'Sharp-eyed duelist. Team Yellow.' },
  { id: 3, name: 'BLOB',   color: '#3ba24f', dark: '#256b34', desc: 'Easy-going area painter. Team Green.' },
];
